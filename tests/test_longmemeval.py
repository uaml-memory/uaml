...
def populated_store(store):
    ...
    store.learn("Agent-A is the coordinator agent, runs on a dedicated VPS",
                topic="team", data_layer="team", confidence=0.95)
    store.learn("Agent-B handles GPU-heavy work on a local workstation",
                topic="team", data_layer="team", confidence=0.95)
    store.learn("Admin is the project lead and final decision maker",
